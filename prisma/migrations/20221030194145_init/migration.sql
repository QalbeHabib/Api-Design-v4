...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_belongedToId_fkey" FOREIGN KEY ("belongedToId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
